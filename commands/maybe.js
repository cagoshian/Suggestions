...
client.guilds.get(message.guildID).channels.get(db.fetch(`suggestion_${message.guildID}_${sugid}.channel`)).getMessage(db.fetch(`suggestion_${message.guildID}_${sugid}.msgid`)).then(async msg => {
  ...
  if (args.slice(1).join(' ')) {
    if (!db.has(`maybechannel_${message.guildID}`) || db.fetch(`maybechannel_${message.guildID}`) == msg.channel.id || !msg.channel.guild.channels.has(db.fetch(`maybechannel_${message.guildID}`))) {
        msg.edit({embed: {title: `Suggestion #${sugid}`, description: db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`), color: 16776960, author: {name: `Potential suggestion - ${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).username}#${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).discriminator}`, icon_url: client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).avatarURL || client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).defaultAvatarURL}, footer: {text: client.user.username, icon_url: client.user.avatarURL || client.user.defaultAvatarURL}, fields: [{name: `${message.author.username}'s reason`, value: args.slice(1).join(' ')}]}})
        db.set(`suggestion_${message.guildID}_${sugid}.channel`, msg.channel.id)
        msg.removeReactions()
    }
    if (db.has(`maybechannel_${message.guildID}`) && db.fetch(`maybechannel_${message.guildID}`) != msg.channel.id) {
        msg.delete()
        client.guilds.get(message.guildID).channels.get(db.fetch(`maybechannel_${message.guildID}`)).createMessage({embed: {title: `Suggestion #${sugid}`, description: db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`), color: 16776960, author: {name: `Potential suggestion - ${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).username}#${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).discriminator}`, icon_url: client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).avatarURL || client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).defaultAvatarURL}, footer: {text: client.user.username, icon_url: client.user.avatarURL || client.user.defaultAvatarURL}, fields: [{name: `${message.author.username}'s reason`, value: args.slice(1).join(' ')}]}}).then(async masg => {
    ...
    db.set(`suggestion_${message.guildID}_${sugid}.status`, 'potential')
    if (!db.has(`denydm_${db.fetch(`suggestion_${message.guildID}_${sugid}.author`)}`)) client.users.get(db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).getDMChannel().then(async ch => ch.createMessage({embed: {title: 'Your suggestion is now potential!', description: `Your suggestion has is now potential in \`${message.channel.guild.name}\`.\n**Suggestion:** ${db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`)}\n**Suggestion number:** ${sugid}\n**Reason:** ${args.slice(1).join(' ')}`, color: 16776960}}))
  }
  if (!args.slice(1).join(' ')) {
    if (!db.has(`maybechannel_${message.guildID}`) || db.fetch(`maybechannel_${message.guildID}`) == msg.channel.id || !msg.channel.guild.channels.has(db.fetch(`maybechannel_${message.guildID}`))) {
        ...
        if (db.has(`maybechannel_${message.guildID}`) && db.fetch(`maybechannel_${message.guildID}`) != msg.channel.id) {
        msg.delete()
        client.guilds.get(message.guildID).channels.get(db.fetch(`maybechannel_${message.guildID}`)).createMessage({embed: {title: `Suggestion #${sugid}`, description: db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`), color: 16776960, author: {name: `Potential suggestion - ${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).username}#${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).discriminator}`, icon_url: client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).avatarURL || client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).defaultAvatarURL}, footer: {text: client.user.username, icon_url: client.user.avatarURL || client.user.defaultAvatarURL}}}).then(async masg => {
        db.set(`suggestion_${message.guildID}_${sugid}.channel`, masg.channel.id)
        db.set(`suggestion_${message.guildID}_${sugid}.msgid`, masg.id)
        })
    }
    db.set(`suggestion_${message.guildID}_${sugid}.status`, 'potential')
    if (!db.has(`denydm_${db.fetch(`suggestion_${message.guildID}_${sugid}.author`)}`)) client.users.get(db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).getDMChannel().then(async ch => ch.createMessage({embed: {title: 'Your suggestion is now potential!', description: `Your suggestion has is now potential in \`${message.channel.guild.name}\`.\n**Suggestion:** ${db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`)}\n**Suggestion number:** ${sugid}`, color: 16776960}}))
  }
})
}catch(e){
...
if (dil == "turkish") {
  ...
  client.guilds.get(message.guildID).channels.get(db.fetch(`suggestion_${message.guildID}_${sugid}.channel`)).getMessage(db.fetch(`suggestion_${message.guildID}_${sugid}.msgid`)).then(async msg => {
    ...
    if (args.slice(1).join(' ')) {
      if (!db.has(`maybechannel_${message.guildID}`) || db.fetch(`maybechannel_${message.guildID}`) == msg.channel.id || !msg.channel.guild.channels.has(db.fetch(`maybechannel_${message.guildID}`))) {
          msg.edit({embed: {title: `Öneri #${sugid}`, description: db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`), color: 16776960, author: {name: `Düşünülecek öneri - ${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).username}#${client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).discriminator}`, icon_url: client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).avatarURL || client.users.find(u => u.id == db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).defaultAvatarURL}, footer: {text: client.user.username, icon_url: client.user.avatarURL || client.user.defaultAvatarURL}, fields: [{name: `${message.author.username} adlı yetkilinin cevabı`, value: args.slice(1).join(' ')}], image: {url: db.fetch(`suggestion_${message.guildID}_${sugid}.attachment`)}}})
          db.set(`suggestion_${message.guildID}_${sugid}.channel`, msg.channel.id)
          msg.removeReactions()
      }
      if (db.has(`maybechannel_${message.guildID}`) && db.fetch(`maybechannel_${message.guildID}`) != msg.channel.id) {
      ...
      db.set(`suggestion_${message.guildID}_${sugid}.status`, 'potential')
      if (!db.has(`denydm_${db.fetch(`suggestion_${message.guildID}_${sugid}.author`)}`)) client.users.get(db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).getDMChannel().then(async ch => ch.createMessage({embed: {title: 'Önerin artık düşünülecek!', description: `Önerin \`${message.channel.guild.name}\` sunucusunda düşünülecek.\n**Öneri:** ${db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`)}\n**Öneri numarası:** ${sugid}\n**Sebep:** ${args.slice(1).join(' ')}`, color: 16776960}}))
    }
    if (!args.slice(1).join(' ')) {
      if (!db.has(`maybechannel_${message.guildID}`) || db.fetch(`maybechannel_${message.guildID}`) == msg.channel.id || !msg.channel.guild.channels.has(db.fetch(`maybechannel_${message.guildID}`))) {
      ...
      db.set(`suggestion_${message.guildID}_${sugid}.status`, 'potential')
      if (!db.has(`denydm_${db.fetch(`suggestion_${message.guildID}_${sugid}.author`)}`)) client.users.get(db.fetch(`suggestion_${message.guildID}_${sugid}.author`)).getDMChannel().then(async ch => ch.createMessage({embed: {title: 'Önerin artık düşünülecek!', description: `Önerin \`${message.channel.guild.name}\` sunucusunda düşünülecek.\n**Öneri:** ${db.fetch(`suggestion_${message.guildID}_${sugid}.suggestion`)}\n**Öneri numarası:** ${sugid}`, color: 16776960}}))
    }
  })
  }catch(e){
...
module.exports.help = {
  name: "maybe",
  nametr: "düşünülecek",
  aliase: ["maybesuggestion", "düşünülecek"],
  descriptionen: "Allows to make any suggestion potential.",
  descriptiontr: "Herhangi bir öneriyi düşünülecek yapmanıza yarar.",
